...
public class ChestSLider : MonoBehaviour
{
    ...
    // fix button 
    public TextMeshProUGUI fixButtonSliderValue;
    public Slider fixButtonSlider;
    ...
    public void ChangeValue(Action action)
    {
        ...
        fixButtonSliderValue.text = (mySlider.value + 1).ToString() + "/" + fixButtonSlider.maxValue.ToString();
    ...
    public void SetCurrentValue(int value)
    {
        ...
        fixButtonSlider.value = value;  
        fixButtonSliderValue.text = fixButtonSlider.value.ToString() + "/" + fixButtonSlider.maxValue.ToString();
        //strikeScore.text = (Mathf.Round(mySlider.value)).ToString();
