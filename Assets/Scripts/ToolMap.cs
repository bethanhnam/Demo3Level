...
//    [MenuItem("Component/SetExtraHole")]
//    public static void SetExtraHole()
//    {
//        Transform obj = Selection.activeTransform;
//        //for (int j = 0; j < obj.childCount; j++)
//        //{
...
//            PrefabUtility.RecordPrefabInstancePropertyModifications(obj);
//        }
//        // Đường dẫn để lưu prefab
//        string localPath = "Assets/PrefabLevelTest 1/" + obj.name + ".prefab";
...
//    [MenuItem("Component/NailToHoleInSquare1")]
//    public static void NailToHoleInSquare1()
//    {
//        Transform obj = Selection.activeTransform;
//        for (int i = 0; i < obj.childCount; i++)
//        {
