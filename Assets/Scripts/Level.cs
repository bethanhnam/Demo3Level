...
//		if (this.Item.itemImg.rect.size.x >= 700 || this.Item.itemImg.rect.size.y >= 700)
//		{
//			s.Append(item1.transform.DOScale(new Vector3(1, 1, 1), 0.5f));
//		}
//		else
//		{
...
//			UIManager.instance.menuPanel.MoveItem1(item1, MenuLevelManager.instance.levelInstances[0].GetComponent<MenuLevel>().currentPlayButtons, transformFixImg);
//		});
//	}
//	public void SetHasdone()
//	{
//		GameManager.instance.currentLevelButton.hasDone = true;
//		GameManager.instance.currentLevelButton.gameObject.SetActive(false);
//		transformFixImg = GameManager.instance.currentLevelButton.fixedImg.transform;
//		if (!MenuLevelManager.instance.levelInstances[0].GetComponent<MenuLevel>().completeList.Contains(GameManager.instance.currentLevelButton.gameObject))
//		{
//			MenuLevelManager.instance.levelInstances[0].GetComponent<MenuLevel>().completeList.Add(GameManager.instance.currentLevelButton.gameObject);
//			MenuLevelManager.instance.levelInstances[0].GetComponent<MenuLevel>().unCompleteList.Remove(GameManager.instance.currentLevelButton.gameObject);
