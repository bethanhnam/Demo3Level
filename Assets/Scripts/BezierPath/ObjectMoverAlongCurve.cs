...
public class ObjectMoverAlongCurve : MonoBehaviour
{
    ...
    public void MoveToFix(ObjectMoverAlongCurve star, Vector3 pos, Vector3 targetAnchor, Vector3 scaleTarget, int curveDirection, Vector3 curve, Action action, int direction = 1)
    {
