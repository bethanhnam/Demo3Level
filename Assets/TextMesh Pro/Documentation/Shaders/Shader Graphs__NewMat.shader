...
Shader "Shader Graphs/_NewMat"
{
  Properties
  {
    [NoScaleOffset] _MainTex ("MainTex", 2D) = "white" {}
    [NoScaleOffset] Noise1 ("Noise1", 2D) = "white" {}
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Sprite Unlit
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0.xyz = texture(Noise1, in_f.texcoord.xy).xyz;
          
          u_xlat16_1 = texture(_MainTex, in_f.texcoord.xy);
          
          u_xlat16_1.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz;
          
          u_xlat0_d = in_f.texcoord1 * _RendererColor;
