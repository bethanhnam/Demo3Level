...
TROUBLESHOOTING
---------------
* Almost all prefabs have the CFXR_Effect script attached: it 
s auto-destruction or deactivation of the GameObject once an effect has finished playing, as well as camera shake and light animation where relevant
