...
public class reciveRewardPanel : MonoBehaviour
{
    ...
    public void takeReward()
    {
        if (dailyPanel.isClaim == true)
        {
            ...
            SaveSystem.instance.AddBooster(rewardsDaily[dailyPanel.lastDate].powerTicket, rewardsDaily[dailyPanel.lastDate].magicTiket, rewardsDaily[dailyPanel.lastDate].extraHolePoint);
        ...
        else if (dailyPanel.isClaimX2)
        {
            ...
            rewardsDaily[dailyPanel.lastDate].isClaim = true;
            SaveSystem.instance.days = dailyPanel.lastDate + 1;
            SaveSystem.instance.AddBooster(rewardsDaily[dailyPanel.lastDate].powerTicket * 2, rewardsDaily[dailyPanel.lastDate].magicTiket * 2, rewardsDaily[dailyPanel.lastDate].extraHolePoint *2);
